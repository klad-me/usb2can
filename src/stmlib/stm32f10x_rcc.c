...
*				  Once the RTC clock is selected it canТt be changed unless the
...
FunctionalState RCC_GetRTCCLK(void)
{
	return  *(vu32 *) BDCR_RTCEN_BB;
}
...
* Description	: Clears the RCCТs interrupt pending bits.
