...
* Description	: Enables or disables the USARTТs DMA interface.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
...
* Description	: Enables or disables the USARTТs LIN mode.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
...
* Description	: Enables or disables the USARTТs Smart Card mode.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
...
* Description	: Enables or disables the USARTТs Half Duplex communication.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
...
* Description	: Configures the USARTТs IrDA interface.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
...
* Description	: Enables or disables the USARTТs IrDA interface.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
...
* Description	: Clears the USARTxТs interrupt pending bits.
* Input		  : - USARTx: where x can be 1, 2 or 3 to select the USART
*					peripheral.
